...
def save_image(img_url, directory, base_url):
    try:
        ...
        if img_url.startswith('data:image'):
            ...
            # Generate a filename
            img_filename = f"data_image_{len(os.listdir(directory)) + 1}.png"  # Placeholder filename
...
def web_scraping(url):
    ...
    if response.status_code == 200:
        ...
        # Extract CSS files linked to the webpage
        ...
        for css in css_links:
            ...
            try:
                ...
                css_response.raise_for_status()  # Check if the request was successful
